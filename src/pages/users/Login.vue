            ...
            <q-card flat class="bg-white text-black">
              <div class="row">
                <div class="col-md-6 col-xs-14">
                  <div class="row q-pt-md q-pb-md bg-teal-0">
                    <div class="col-md-10 offset-2 col-xs-4">
                      <q-img spinner-color="white" placeholder-src="statics/perabotan.png" src="statics/perabotan.png"></q-img>
                    </div>
                  </div>
                </div>
