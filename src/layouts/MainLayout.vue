            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">18415002</div>
                  <div>Anisa Nurul Fallah</div>
                </div>
              </div>
        ...
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">18415002</div>
              <div>Anisa Nurul Fallah</div>
            </div>
          </q-item>
          <q-item-label
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/inputdataperabotan">
            <q-item-section avatar>
              <q-icon name="library_add" />
            </q-item-section>
            <q-item-section>
              Input Data Perabotan
            </q-item-section>
          </q-item>
          <q-item-label
            header
